...
@section('titleBar', 'Data kategoritarif')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <a href="{{ route('admin.kategoritarif.create') }}" class="btn btn-info btn-sm m-0" id="tambah-data">Tambah</a>
                            

                            <table id="kategoritarif" class="table table-bordered">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>Kode</th>
...
<script>
    ...
    $(function() {
        ...
        $('#kategoritarif').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('admin.kategoritarif.index') }}",
            dom: 'flrtp',
            columns: [
                { data: 'DT_RowIndex', name: 'DT_RowIndex', orderable: false, searchable: false}, 
                { data: 'kodekategori', name: 'kodekategori' },     
