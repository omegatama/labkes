...
@section('titleBar', "Laporan Belanja Persediaan")
                ...
                <div class="col-lg-6 col-md-8">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">
                                Laporan Belanja Persediaan
                            </h4>
                        </div>
                        <div class="card-body">
                            <form class="form" method="POST" action="{{ route('admin.proses.persediaantahun') }}">
                                @csrf
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group mb-1">
                                        <label class="m-0" for="ta">TA</label>
