...
@section('titleBar', 'data pendidikan')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <a href="{{ route('admin.pendidikan.create') }}" class="btn btn-info btn-sm m-0" id="tambah-data">Tambah</a>
                            
                            <table id="pendidikan" class="table table-bordered">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>Kode</th>
