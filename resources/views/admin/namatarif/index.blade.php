...
@section('titleBar', 'Data Nama Tarif')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <a href="{{ route('admin.namatarif.create') }}" class="btn btn-info btn-sm m-0" id="tambah-data">Tambah</a>
                            

                            <table id="namatarif" class="table table-bordered">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>Kode Tarif</th>
...
<script>
    ...
    $(function() {
        ...
        $('#namatarif').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('admin.namatarif.index') }}",
            dom: 'flrtp',
            columns: [
                { data: 'DT_RowIndex', name: 'DT_RowIndex', orderable: false, searchable: false}, 
                { data: 'kodenamatarif', name: 'kodenamatarif' },     
                { data: 'namatarif', name: 'namatarif' },
