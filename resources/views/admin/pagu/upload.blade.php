            ...
            <div class="row justify-content-md-center">
                <div class="col-lg-6 col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="form" method="POST" action="{{ route('admin.pagu.proses_upload') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="form-body">
                                    <div class="row">
                                ...
                                <div class="form-actions pb-0">
                                    <a href="{{ asset('storage/format/formatpagu.xlsx') }}" target="_blank">
