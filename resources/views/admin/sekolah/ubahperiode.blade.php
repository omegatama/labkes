...
@section('titleBar', "Ubah Periode Aktif Sekolah")
                ...
                <div class="col-lg-6 col-md-8">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">
                                Ubah Periode Aktif<br>
                                {{$sekolah->name}}
                            </h4>
                        </div>
                        <div class="card-body">
                            <form class="form" method="POST" action="{{ route('admin.sekolah.proses_ubahperiode', ['id'=>$sekolah->id]) }}">
                                @csrf
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group mb-1">
                                        ...
                                        <input value="{{$sekolah->periode_awal}}" type="date" name="periode_awal" id="periode_awal" class="form-control">
                                    </div>
                                    <div class="form-group mb-1">
                                        <label class="m-0" for="periode_akhir">Periode Akhir</label>
                                        <input value="{{$sekolah->periode_akhir}}" type="date" name="periode_akhir" id="periode_akhir" class="form-control">
                                    </div>
