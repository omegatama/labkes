...
@section('titleBar', "Setel Status RKA Sekolah")
            ...
            <div class="row justify-content-md-center">
                <div class="col-lg-6 col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="form" method="POST" action="{{ route('admin.sekolah.proses_set_lockrka') }}">
                                @csrf
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group mb-1">
                                        <label class="m-0" for="kunci_rka">Status RKA</label>
                                        <select class="form-control" name="kunci_rka" id="kunci_rka" required="">
                                            <option value=""></option>
