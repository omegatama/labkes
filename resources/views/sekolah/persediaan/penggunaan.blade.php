...
@section('titleBar', 'Penggunaan Persediaan')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <a href="{{ route('sekolah.trxpersediaan.create') }}" class="btn btn-info btn-sm m-0" id="tambah-data">Tambah</a>
                            <div>
...
<script>
    $(function() {
        $('#tabelPenggunaan').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('sekolah.persediaan.penggunaan') }}",
            dom: 'flrtp',
            columns: [
