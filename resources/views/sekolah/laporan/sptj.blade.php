            ...
            <div class="row justify-content-md-center">
                <div class="col-lg-6 col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="form" method="POST" action="{{ route('sekolah.proses.sptj') }}">
                                @csrf
                                ...
                                <div class="form-body">
                                    ...
                                    {{-- <div class="form-group mb-1">
                                        ...
                                        <input type="text" class="form-control" id="nomor_tanggal_dpa" name="nomor_tanggal_dpa" placeholder="Nomor / Tanggal DPA-SKPD" required>
                                    </div> --}}

                                    <div class="form-group mb-1">
                                        <label class="m-0" for="nomor_sptj">Nomor SPTJ</label>
                                        <input type="text" class="form-control" id="nomor_sptj" name="nomor_sptj" required placeholder="Nomor SPTJ">
                                    </div>
