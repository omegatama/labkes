...
@section('titleBar', "Laporan SPTMH")
                        ...
                        <div class="card-body">
                            <form class="form" method="POST" action="{{ route('sekolah.proses.sptmh') }}">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group mb-1">
                                        <label class="m-0" for="nomor_sptmh">Nomor SPTMH</label>
                                        <input type="text" class="form-control" id="nomor_sptmh" name="nomor_sptmh" required placeholder="Nomor SPTMH">
                                    </div>
