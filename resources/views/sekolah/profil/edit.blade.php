            ...
            <div class="row justify-content-md-center">
                <div class="col-lg-6 col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="form" method="POST" action="{{route('sekolah.profil.update')}}">
                                @csrf
                                ...
                                <div class="form-actions pb-0 text-right">
                                    <a href="{{ route('sekolah.profil.index') }}">
...
<script>
    $(document).ready(function () {
        $('#kecamatan_id').select2({
            ajax: {
                url: "{{ route('sekolah.select.kecamatan') }}",
