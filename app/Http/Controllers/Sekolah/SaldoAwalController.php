...
class SaldoAwalController extends Controller
{
    ...
    public function hitung(Request $request, $id)
    {
        ...
        $saldoakhir_bank= ($saldoawal_bank + $pendapatan_bank) - $belanja_bank;
        $saldoakhir_tunai= ($saldoawal_tunai + $pendapatan_tunai) - $belanja_tunai;
    	$saldoakhir = $saldoakhir_bank + $saldoakhir_tunai;
